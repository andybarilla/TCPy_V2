...
def main():
    ...
    Use this method to return a single email result by passing
    an email id.
    ...
    if False:
        # get email by id
        email_id = 45621
        results = tc.get_email_by_id(email_id)
    ...
    Method:
    get_emails(owners=<list of owners>)
      owners -> (optional) list of owners

    Use this method to return email data. A list of owners can be optionally
    ...
    """
    Get Emails by Indicator

    Method:
    get_emails_by_indicator(indicator, indicator_type=None, owners=[]:
      indicator -> any indicator
      indicator_type -> (optional) indicator type
      owners -> (optional) list of owners

    Use this method to return emails by a user provided indicator. Optionally
    ...
    if False:
        # get emails by indicator for default owner
        indicator = "218.65.4.171"
        results = tc.get_emails_by_indicator(indicator)
    ...
    if False:
        # get emails by indicator for all owners
        indicator = "1.2.3.4"
        requested_owners = tc.get_owners().data().name_list()
        results = tc.get_emails_by_indicator(indicator, owners=requested_owners)
    ...
    Method:
    get_emails_by_tag(tag_name, owners=[]):
      tag_name -> a tag name
      owners -> (optional) list of owners

    Use this method to return emails by a user provided tag name. A
    ...
    if False:
        # get emails by tag for default owner
        tag = "adam"
        results = tc.get_emails_by_tag(tag)
    ...
    if False:
        # get emails by tag for all owners
        tag = "Advanced Persistent Threat"
        requested_owners = tc.get_owners().data().name_list()
        results = tc.get_emails_by_tag(tag, requested_owners)
